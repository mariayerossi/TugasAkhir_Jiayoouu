...
class requestPenawaran extends Model
{
    ...
    public function get_all_data() {
        return requestPenawaran::where('deleted_at',"=",null)->get();
    }
    ...
    public function get_all_data_by_lapangan($role){
        return requestPenawaran::where('deleted_at',"=",null)->where("req_lapangan", "=", $role)->where("status_penawaran","=", "Disewakan")->get();
    }
