...
class lapanganOlahraga extends Model
{
    ...
    public function get_all_data_status($role){
        return lapanganOlahraga::where('deleted_at',"=",null)->where("pemilik_lapangan","=",$role)->where("status_lapangan","=","Aktif")->get();
    }
    ...
    public function get_all_data_for_admin(){
        return lapanganOlahraga::where('deleted_at',"=",null)->get();
    }
    ...
    public function get_all_data_by_id2($id){
        return lapanganOlahraga::where("id_lapangan","=",$id)->get();
    }
