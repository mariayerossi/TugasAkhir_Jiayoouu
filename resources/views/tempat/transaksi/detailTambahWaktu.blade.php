...
<style>
    ...
    <div class="container mt-5 mb-5 bg-white p-4 rounded" style="box-shadow: 0px 8px 16px 0px rgba(0, 0, 0, 0.2);">
        ...
        <div class="d-flex justify-content-center">
            <div class="alert alert-warning" role="alert">
                <i class="bi bi-exclamation-circle"></i> Customer membayar total extend ini kepada Anda secara TUNAI, dan saldo Anda akan otomatis dikurangi sebesar total yang dibayar oleh customer.
            </div>
        </div>
        @php
        ...
        <a href="/tempat/lapangan/lihatDetailLapangan/{{$trans->id_lapangan}}">
            <div class="card">
                <div class="card-body">
        ...
        <div class="d-flex justify-content-end mt-5 me-3 mb-5">
            ...
            @if ($cek->isEmpty())
                ...
                <form id="bookingForm" action="/tempat/transaksi/tambahWaktu" method="post">
                    @csrf
    ...
    <script>
        ...
        document.getElementById('confirmBooking').addEventListener('click', function(event) {
            ...
            $.ajax({
                url: "/tempat/transaksi/tambahWaktu",
                type: "POST",
                data: formData,
