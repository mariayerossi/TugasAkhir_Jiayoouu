    ...
    <div class="container-fluid h-custom">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form action="/pemilik/saldo/tambahDetail" method="post" id="tambahForm">
                    @csrf
                    ...
                    @else
                        ...
                        <h5>Nama Bank: {{Session::get("dataRole")->nama_bank_pemilik}}</h5>
                        <h5>Nomer Rekening: {{Session::get("dataRole")->norek_pemilik}}</h5>
                        <h5>Nama Rekening: {{Session::get("dataRole")->nama_rek_pemilik}}</h5>
                    @endif
                </form>
            </div>
        </div>
...
<script>
    $("#tambah").click(function(event) {
        ...
        $.ajax({
            url: "/pemilik/saldo/tambahDetail",
            type: "POST",
            data: formData,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(() => {
                        // window.history.back();
                        window.location.href = "/pemilik/saldo/tarikSaldo"
