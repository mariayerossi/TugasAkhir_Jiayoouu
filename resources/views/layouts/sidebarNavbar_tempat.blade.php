    ...
    <div id="main">
        ...
        <nav>
            ...
            @php
                ...
                $total_saldo = DB::table('pihak_tempat')->where("id_tempat","=",Session::get("dataRole")->id_tempat)->get()->first()->saldo_tempat;
            ...
            <div class="coba">
                <div class="notif-dropdown me-3">
                    ...
                    <div class="notif-dropdown-content ">
                        ...
                        <a href="/notifikasi/tempat/lihatNotifikasi" class="text-center">Lihat Semua Notifikasi</a>
                    </div>
                </div>
                <div class="profile-dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        @if (Session::get("dataRole")->norek_tempat == null)
                            <a href="/tempat/saldo/noRek"><i class="bi bi-cash-coin me-2"></i>Tarik Saldo</a>
                        @else
                            <a href="/tempat/saldo/tarikSaldo"><i class="bi bi-cash-coin me-2"></i>Tarik Saldo</a>
                        @endif
